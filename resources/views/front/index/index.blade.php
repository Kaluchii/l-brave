...
@section('content')
                ...
                <div class="about__free-exercise free-exercise">
                    ...
                    <div class="free-exercise__btn-with-text">
                        <div class="free-exercise__btn-wrap">
                            <a href="#" class="free-exercise__btn b-button">ЗАПИСАТЬСЯ</a>
                        </div>
    ...
    <section class="b-challenges-conversion" style="background-image: url('/img/challenges-conversion-background.png');">
        <div class="b-container">
            <div class="b-challenges-conversion__container">
                <h3 class="b-heading b-heading_style_white b-challenges-conversion__heading">Первый вызов</h3>
                <p class="b-challenges-conversion__text">Мы делаем вам первый вызов —<br />выполнять простое действие каждый день.<br />Вы готовы?</p>
                <a href="#" class="b-link b-button b-button_size_medium b-challenges-conversion__link">Принять вызов</a>
            </div>
        </div>
    </section>
    ...
    <section class="b-quote-lead">
        <div class="b-container">
            <h3 class="b-heading b-quote-lead__heading">Лучше время посадить дерево — 20 лет назад.<br>
                Второе лучшее время — сейчас.</h3>
            <p class="b-quote-lead__text">Китайская пословица</p>
            <img src="/img/quote-china.png" alt="Китайский мудрец" class="b-quote-lead__image">
        </div>
    </section>
