                    ...
                    <div class="about__free-exercise free-exercise">
                        ...
                        <div class="free-exercise__btn-with-text">
                            <div class="free-exercise__btn-wrap">
                                <a href="#offer_form" class="free-exercise__btn button js_call_back" data-offer-name="Бесплатная тренировка"><span class="button__text">ЗАПИСАТЬСЯ</span></a>
                            </div>
        ...
        <section class="main-page__create-profile create-profile">
            <div class="create-profile__wrapper">
                ...
                <div class="create-profile__btn-wrap">
                    <a href="#offer_form" class="create-profile__btn button js_call_back" data-offer-name="{!! $signing->title !!}><span class="button__text">ЗАПИСАТЬСЯ</span></a>
                </div>
            </div>
        </section>
        ...
        <section class="main-page__first-challenge first-challenge">
            <div class="first-challenge__wrapper">
                ...
                <div class="first-challenge__btn-wrap">
                    <a href="#offer_form" class="first-challenge__btn button js_call_back" data-offer-name="{!! $challenge->title !!}><span class="button__text">ПРИНЯТЬ ВЫЗОВ</span></a>
                </div>
            </div>
        </section>
